  ...
  return (
    <div
      ...
      className={`w-full z-20 flex flex-row ${
        isSelected
          ? "bg-slate-400/20 backdrop-blur-lg hover:bg-slate-200 "
          : "hover:bg-zinc-100 "
      }   active:bg-slate-200 h-12 rounded-xl p-2 pl-3 my-1 items-center duration-100 select-none justify-between`}
    >
